...
#define C_EN_Pin GPIO_PIN_4
#define C_EN_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define Z_MAX_Pin GPIO_PIN_6
#define Z_MAX_GPIO_Port GPIOA
#define X_MIN_Pin GPIO_PIN_0
#define X_MIN_GPIO_Port GPIOB
#define C_DIR_Pin GPIO_PIN_7
#define C_DIR_GPIO_Port GPIOC
#define C_STEP_Pin GPIO_PIN_9
