/****************************************************************************
** Meta object code from reading C++ file 'ProfileWidget.hpp'
**
...
#include "../../../../app/ui/widgets/ProfileWidget.hpp"
...
#error "The header file 'ProfileWidget.hpp' doesn't include <QObject>."
...
template <> constexpr inline auto ProfileWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13ProfileWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'updateProfile'
        QtMocHelpers::SlotData<void(float, const QVector<QPointF> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ProfileWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateProfile((*reinterpret_cast<std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QList<QPointF>>>(_a[2]))); break;
