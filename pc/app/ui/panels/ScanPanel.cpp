...
ScanPanel::ScanPanel(ScanController* ctrl, QWidget* parent) : QWidget(parent), m_ctrl(ctrl)
{
    setMinimumWidth(300);
    ...
    connect(m_addLayerBtn, &QPushButton::clicked, this,
            [this]()
            {
                QString path =
...
void ScanPanel::appendLog(const QString& level, const QString& msg)
{
    ...
    QString color =
        (level == "ERR" || level == "WARN") ? "#e74c3c" : (level == "OK" ? "#2ecc71" : "#888");
    m_logView->append(
