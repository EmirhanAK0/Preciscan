...
ConnectingOverlay::ConnectingOverlay(QWidget* parent) : QWidget(parent, Qt::Widget)
{
    ...
    connect(m_spinTimer, &QTimer::timeout, this,
            [this]
            {
    ...
    connect(m_closeTimer, &QTimer::timeout, this,
            [this]
            {
                hide();
                stopSpinner();
