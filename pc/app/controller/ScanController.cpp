...
void ScanController::connectLaserSim(const QString& stlPath)
{
    ...
    emit laserConnectionChanged(true);
    emit logMessage("OK",
                    QString("Lazer simülasyonu hazır: %1").arg(QFileInfo(stlPath).fileName()));
    ...
    connect(m_simWorker, &sim::LaserSimWorker::profileReady, this,
    ...
    connect(m_simWorker, &sim::LaserSimWorker::progressUpdated, this,
            &ScanController::simProgressUpdated);
    connect(m_simWorker, &sim::LaserSimWorker::scanComplete, this,
